...
from PKUDatasets import PKUMotionProcessor
...
def gendata(dataset_path, out_path, benchmark, part='eval'):
    ...
    f_position = open_memmap(
        '{}/{}_position64.npy'.format(out_path, part),
        dtype='float32',
        mode='w+',
    ...
    f_label = open_memmap(
        '{}/{}_label64.npy'.format(out_path, part),
        dtype='int64',
        mode='w+',
        shape=(dataset.N, 1))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_path', default='/root/autodl-tmp/FGE/data/pkummd/part1')
