...
def gendata(data_path,
            ...
            benchmark='xview',
            part='eval'):
    training_split_file_folder = '/root/autodl-tmp/data/pkummd/part1/Split/'
    if benchmark=='xview':
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='/root/autodl-tmp/FGE/data/pkummd_raw/part1/skeleton_pku_v1')
    parser.add_argument('--out_folder', default='/root/autodl-tmp/FGE/data/pkummd/part1')

    parser.add_argument('--ignored_sample_path',
                        default='/root/autodl-tmp/FGE/data/pkummd/part1/samples_with_missing_skeletons.txt')
