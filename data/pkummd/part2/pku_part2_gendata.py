...
def gendata(data_path,
            ...
            benchmark='xview',
            part='eval'):
    training_split_file_folder = '/root/autodl-tmp/data/pkummd/part2/Split/'
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--data_path', default='/root/autodl-tmp/FGE/data/pkummd_raw/part2/skeleton_pku_v2')
    parser.add_argument('--out_folder', default='/root/autodl-tmp/FGE/data/pkummd/part2/')

    parser.add_argument('--ignored_sample_path',
                        default='/root/autodl-tmp/FGE/data/pkummd/part2/samples_with_missing_skeletons.txt')
